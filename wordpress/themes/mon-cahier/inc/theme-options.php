		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><?php _e( 'Enter your Pinterest URL', 'mon_cahier' ); ?></th>
					<td>
						<input id="mon_cahier_theme_options" class="regular-text" type="text" name="mon_cahier_theme_options[pinteresturl]" value="<?php esc_attr_e( $options['pinteresturl'] ); ?>" />
						<label class="description" for="mon_cahier_theme_options[pinteresturl]"><?php _e( 'Leave blank to hide Pintrest Icon', 'mon_cahier' ); ?></label>
					</td>
				</tr>
				<?php
				/**
				 ...
				 */
				?>
				<tr valign="top"><th scope="row"><?php _e( 'Enter your Dribble URL', 'mon_cahier' ); ?></th>
					<td>
						<input id="mon_cahier_theme_options" class="regular-text" type="text" name="mon_cahier_theme_options[dribbleurl]" value="<?php esc_attr_e( $options['dribbleurl'] ); ?>" />
						<label class="description" for="mon_cahier_theme_options[dribbleurl]"><?php _e( 'Leave blank to hide Dribble Icon', 'mon_cahier' ); ?></label>
					</td>
				</tr>
				<?php
				/**
				 ...
				 */
				?>
				<tr valign="top"><th scope="row"><?php _e( 'Enter your Delicious URL', 'mon_cahier' ); ?></th>
					<td>
						<input id="mon_cahier_theme_options" class="regular-text" type="text" name="mon_cahier_theme_options[deliciousurl]" value="<?php esc_attr_e( $options['deliciousurl'] ); ?>" />
						<label class="description" for="mon_cahier_theme_options[deliciousurl]"><?php _e( 'Leave blank to hide Delicious Icon', 'mon_cahier' ); ?></label>
					</td>
				</tr>
				 ...
				 */
				?>
				<tr valign="top"><th scope="row"><?php _e( 'Enter your Github URL', 'mon_cahier' ); ?></th>
					<td>
						<input id="mon_cahier_theme_options" class="regular-text" type="text" name="mon_cahier_theme_options[githuburl]" value="<?php esc_attr_e( $options['githuburl'] ); ?>" />
						<label class="description" for="mon_cahier_theme_options[githuburl]"><?php _e( 'Leave blank to hide Github Icon', 'mon_cahier' ); ?></label>
					</td>
				</tr>
				<?php
				/**
				 ...
				 */
				?>
				<tr valign="top"><th scope="row"><?php _e( 'Enter your Tumblr URL', 'mon_cahier' ); ?></th>
					<td>
						<input id="mon_cahier_theme_options" class="regular-text" type="text" name="mon_cahier_theme_options[tumblrurl]" value="<?php esc_attr_e( $options['tumblrurl'] ); ?>" />
						<label class="description" for="mon_cahier_theme_options[tumblrurl]"><?php _e( 'Leave blank to hide Tumblr Icon', 'mon_cahier' ); ?></label>
					</td>
				</tr>
			...
			?>
			<tr valign="top">
				<td colspan="2"><em><?php _e( 'To modify the link colours, please use hexadecimal values such as #cccccc', 'mon_cahier' ); ?></em></td>
			</tr>
