...
E_D("replace into `wp_usermeta` values('14','1','wp_dashboard_quick_press_last_post_id','158');");
...
E_D("replace into `wp_usermeta` values('17','1','closedpostboxes_post','a:0:{}');");
...
E_D("replace into `wp_usermeta` values('19','1','wp_user-settings','libraryContent=browse&align=center&imgsize=large');");
E_D("replace into `wp_usermeta` values('20','1','wp_user-settings-time','1362676395');");
