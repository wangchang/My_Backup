...
E_D("replace into `wp_term_taxonomy` values('2','2','category','','0','7');");
...
E_D("replace into `wp_term_taxonomy` values('7','7','nav_menu','','0','3');");
E_D("replace into `wp_term_taxonomy` values('8','8','category','','0','7');");
...
E_D("replace into `wp_term_taxonomy` values('21','21','post_tag','','0','2');");
E_D("replace into `wp_term_taxonomy` values('22','22','category','','0','1');");
E_D("replace into `wp_term_taxonomy` values('23','23','category','','0','1');");
...
E_D("replace into `wp_term_taxonomy` values('28','28','category','','0','2');");
E_D("replace into `wp_term_taxonomy` values('29','29','post_tag','','0','2');");
